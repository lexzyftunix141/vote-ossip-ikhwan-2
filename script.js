...
window.debugLogin = async function() {
    ...
    try {
        ...
        console.log('2. Checking all voters...');
        const voters = await window.db.getAllVoters();
        console.log('Total voters:', voters.length);
        
        console.log('3. Testing login with siswa001...');
        const testResult = await window.db.validateLogin('siswa001');
        console.log('Test login result:', testResult);
        
        console.log('4. Available usernames:');
        const first10 = voters.slice(0, 10).map(v => v.username);
        console.log(first10);
...
// Tambahkan tombol debug ke halaman (opsional)
document.addEventListener('DOMContentLoaded', function() {
